...
struct ExerciseModel: Identifiable, Codable{
    ...
    var maxRepetitions: String
    var imageUrl: String
    var videoUrl: String
    var description: String
    
    
    init(id: String, bodyRegion:String, exercisesName: String, maxWeight: String, maxRepetitions: String,
...
extension ExerciseModel {
    ...
    [
        ExerciseModel(id: "1", bodyRegion: "Delts & Shoulders", exercisesName: "Arnold Press (Anterior)", maxWeight: "0", maxRepetitions: "0", imageUrl: "https://s35247.pcdn.co/wp-content/uploads/2018/09/3-2-800x600.png", videoUrl: "https://www.youtube.com/watch?v=mXRhpXwW-gs", description: " 1. Grab your dumbbells. \n 2. Take a seat for efficiency, preferably on the workout bench. \n 3. Place the dumbbells on your thighs as you sit. \n 4. Initial position: Keep your back straight and lift the weights just above your shoulder in front of you ( palm facing towards you.) \n 5.Slowly raise your arms and twist your hands inwards and take your arms over your shoulder. Hold for a sec. \nv6. Bring back the arms slowly towards against the resistance, back to the initial position.")
    ]
}
